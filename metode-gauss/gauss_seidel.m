%% 
% Program untuk menyelesaikan persamaan linier menggunakan metode gauss-seidel. 
% Metode ini mirip dengan metode jacobi. Saat di-run, akan dikeluarkan nilai 
% daftar solusi dan paling akhir ditampilkan solusinya.
% 
%%
...
function gauss_seidel()
  ...
  [solusi, list_solusi] = gauss_seidel(a, 1e-7);
...
% Fungsi untuk menyelesaikan persamaan linier menggunakan metode gauss-seidel.
% 
% @param matrix     persamaan yang ingin dicari penyelesaiannya.
% @param err_limit  nilai error untuk solusi.
function [solusi, list_solusi] = gauss_seidel(matrix, err_limit)
  ...
  while(true)
    ...
    for i = 1:baris
      ...
      solusi(i) = (matrix(i, kolom) - sigma) / matrix(i,i);
